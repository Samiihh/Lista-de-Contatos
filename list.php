...
if (!empty($pagina)) {
    ...
    $query_usuarios = "SELECT  id, nome, apelido, cpf, email, telefone, datacadastro, dataalteracao  FROM contatos ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
    ...
    $query_pg = "SELECT COUNT(id) AS num_result FROM contatos";
