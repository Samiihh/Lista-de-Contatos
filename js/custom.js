...
cadForm.addEventListener("submit", async (e) => {
    ...
    if(document.getElementById("nome").value === ""){
        ...
        msgAlertaErroCad.innerHTML = "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo apelido!</div>";
        ...
        msgAlertaErroCad.innerHTML = "<div class='alert alert-danger' role='alert'>Erro: Necessário preencher o campo Email!</div>";
    }else{
...
async function visUsuario(id){
    ...
    if(resposta['erro']){
        ...
        document.getElementById("apelidoUsuario").innerHTML = resposta['dados'].apelido;
...
async function editUsuarioDados(id){
    ...
    if(resposta['erro']){
        ...
        document.getElementById("editapelido").value = resposta['dados'].apelido;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const filtroForm = document.getElementById('filter-usuario-form'); // Deve estar fora da função de callback
    filtroForm.addEventListener('submit', async (e) => {
        e.preventDefault();

        const filtroData = document.getElementById('filtroData').value;
        const dadosForm = new FormData();
        dadosForm.append('filtroData', filtroData);

        const dados = await fetch('filtrar.php', {
            method: 'POST',
            body: dadosForm,
        });
